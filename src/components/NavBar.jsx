...
function NavBar() {
  return (
    <div className='flex h-[10vh]'>
      <div className='flex bg-[#0d8360] w-[50%]  text-white h-[10vh]'>
        <img className='w-[25%] m-2' src={logo} alt="3030 logo" />
        <p className='md:text-xs lg:text-sm md:m-3 lg:m-4 leading-relaxed'>
      ...
      <div className='bg-[#0b6c4f] w-[50%] '>
        <ul className=' h-[10vh] flex justify-end items-center'>
